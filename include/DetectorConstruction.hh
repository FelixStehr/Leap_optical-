...
class DetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  public:
   ...
   // set Abs and Targ Thicknes
    void SetTargetThicknes (G4double );
    void SetAbsorberThicknes (G4double );
    void SetDetectorMaterial (G4String) ;

    G4double GetAbsorberTicknes() {return magthick;};
    G4double GetTargetTicknes() {return absthick;};
    G4Material* GetDetectorMaterial() {return fdetmat;};
