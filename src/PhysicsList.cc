...
: G4VModularPhysicsList(),
  fEmPhysicsList(0), fOptPhysicsList(0), fEmName("polarized"), fMessenger(0)
{
  ...
  fOptPhysicsList ->SetWLSTimeProfile("delta");

  fOptPhysicsList ->SetScintillationYieldFactor(1.0);
  fOptPhysicsList ->SetScintillationExcitationRatio(0.0);

  fOptPhysicsList ->SetMaxNumPhotonsPerStep(100);
  fOptPhysicsList ->SetMaxBetaChangePerStep(10.0);
...
void PhysicsList::ConstructProcess()
{
  ...
  // Register optical Physics not sure if that works 
  RegisterPhysics(fOptPhysicsList); 
